...
function onResults(results) {
  ...
  if (landmarks != null) {   // drawing landmarks only if landmarks are detected
    ...
    if (distance > 0 && distance < 20) {
      ...
      if (distance > 0 && distance <= 5) {
        ...
        if (lHKA > 160 && rHKA > 160) {
          stage = "down";
        }
        if (lHKA < 50 && rHKA < 50 && stage == "down") {
          stage = "up";
          counter1 += 1;
          counter2 += 1;
        }
        ...
        document.getElementById("backbone").innerHTML = "Please stand sideways";
      }
    }
    else {
